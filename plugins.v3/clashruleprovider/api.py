...
from app.schemas.response import Response as SchemasResponse
...
class ClashRuleProviderApi:
    ...
    def reorder_rules(self, ruleset: RuleSet, target: int,
                      moved_priority: int = Body(..., embed=True)) -> SchemasResponse:
    ...
    def update_rule(self, ruleset: RuleSet, priority: int, rule_data: RuleData) -> SchemasResponse:
    ...
    def add_rule(self, ruleset: RuleSet, rule_data: RuleData = Body(...)) -> SchemasResponse:
    ...
    def update_rule_meta(self, ruleset: RuleSet, priority: int, meta: Metadata = Body(...)) -> SchemasResponse:
    ...
    def delete_rule(self, ruleset: RuleSet, priority: int) -> SchemasResponse:
        self.services.delete_rule(ruleset, priority)
        return SchemasResponse(success=True)

    @apis.register(path="/rules/{ruleset}", methods=["DELETE"], auth="bear", summary="批量删除规则")
    def delete_rules(self, ruleset: RuleSet, priority: list[int] = Body(...)) -> SchemasResponse:
        self.services.delete_rules(ruleset, priority)
        return SchemasResponse(success=True)

    @apis.register(path="/refresh", methods=["PUT"], auth="bear", summary="更新订阅")
    async def refresh_subscription(self, url: str = Body(..., embed=True)) -> SchemasResponse:
    ...
    @apis.register(path="/rule-providers", methods=["GET"], auth="bear", summary="获取规则集合",
                   response_model=SchemasResponse, response_model_exclude_none=True)
    def get_rule_providers(self) -> SchemasResponse:
        return SchemasResponse(success=True, data=self.services.state.all_rule_providers)
    ...
    def get_proxies(self):
        ...
        return SchemasResponse(success=True, data=proxies)
    ...
    def update_proxy(self, name: str, source: DataSource = Body(...), proxy: Proxy = Body(...)) -> SchemasResponse:
    ...
    def get_proxy_groups(self):
        ...
        return SchemasResponse(success=True, data=proxy_groups)
    ...
    def get_proxy_providers(self):
        ...
        return SchemasResponse(success=True, data=proxy_providers)
    ...
    def get_hosts(self):
        return SchemasResponse(success=True, data=self.services.state.hosts.model_dump(mode='json'))
